          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                We collect information you provide when you use PrimePro, including:
              </p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">3. Synth Twin Memory and Stored Data</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">We do not sell your personal data. We may share data only in the following cases:</p>
              <ul className="list-disc pl-6 text-slate-600 space-y-1">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">6. Data Retention</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">7. Third-Party AI Providers</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">8. Cookies & Tracking Technologies</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">10. Changes to This Policy</h2>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800">11. Contact Us</h2>
